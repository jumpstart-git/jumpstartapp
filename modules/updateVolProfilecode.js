...
function validateVolunteerHoursUpdate() {
 // alert("inisde time"+JSON.stringify(volunteerUpdateObject));
  ...
  //Defect D037 - start
  else if (volunteerUpdateObject.aboutMe.length === 0 || volunteerUpdateObject.aboutMe === " ") {
    validationAlert("Missing Details", "Please Enter About Me*");
    return false;
  }
  else if (volunteerUpdateObject.workDetails.length === 0 || volunteerUpdateObject.workDetails === " ") {
 ...
 function validateUpdateInfo()
{
  ...
  //Defect D037 - start
  if (volunteerUpdateObject.aboutMe.length === 0 || volunteerUpdateObject.aboutMe === " ") {
    return false;
  }

  if (volunteerUpdateObject.workDetails.length === 0 || volunteerUpdateObject.workDetails === " ") {
    return false;
  }
	//Defect D037 - end
...
function authenticateMFUsingUserStore(){
             //   alert (" ********** Entering into authenticateMFUsingUserStore ********** ");
                ...
                var authParams = {"userid": mobileFabricConfigurationForMyProfileVol.identityServices[0].username, "password": mobileFabricConfigurationForMyProfileVol.identityServices[0].password};
