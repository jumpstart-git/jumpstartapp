...
kony.application.dismissLoadingScreen();
    ...
    kony.ui.Alert({ message: "Service call failed with opstatus " + TaskDetailsForVolunteer .opstatus,alertType:constants. ALERT_TYPE_ERROR, alertTitle:"Fox News",yesLabel:"OK"}, {});
  }
}
...
function getTaskDetailsForVol()
{
  ...
  var taskVal= mainPage.mainPageBody.mainPageContentParent.myActivity.myAcceptedRequests.acceptedRequestsSegment.selectedRowItems;
    gblTaskReqVal=taskVal[0].lblRequestId;   
