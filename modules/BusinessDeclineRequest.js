...
shouldShowLabelInBottom: "false", separatorHeight: 20} );
      ...
      if (!mobileFabricConfigurationForIndigenousDeclineRequest.isKonySDKObjectInitialized)
      {//alert("1");
           initializeMobileFabricForIndigenousDeclineRequest();
            
      }
      else if (mobileFabricConfigurationForIndigenousDeclineRequest.isKonySDKObjectInitialized)
      {//alert("setIndigenousDeclineRequest");
...
function authenticateMFUsingUserStore(){
                ...
                var authParams = {"userid": mobileFabricConfigurationForIndigenousDeclineRequest.identityServices[0].username, "password": mobileFabricConfigurationForIndigenousDeclineRequest.identityServices[0].password};
