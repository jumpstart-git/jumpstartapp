...
//          kony.application.dismissLoadingScreen();
    ...
    kony.ui.Alert({ message: "Service call failed with opstatus " + DeleteVolunteerAccountList.opstatus,alertType:constants. ALERT_TYPE_ERROR, alertTitle:"Fox News",yesLabel:"OK"}, {});
  }
}//end first if
}//end of fun
