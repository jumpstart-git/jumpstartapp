...
function getReportSupplyNationCodeDataVal()
{
             ...
             //var selectedKey = frmFoxNews.lstNewsType.selectedKey;
                ...
                {
                                //kony.application.showLoadingScreen("loadskin","Fetching news !!!",constants.LOADING_SCREEN_POSITION_FULL_SCREEN , false,true,{enableMenuKey:true,enableBackKey:true, progressIndicatorColor : "ffffff77"});
                                mobileFabricConfigurationForReportSupplyNationCode.integrationObj = mobileFabricConfigurationForReportSupplyNationCode.konysdkObject.getIntegrationService(mobileFabricConfigurationForReportSupplyNationCode.integrationServices[0].service);
                ...
                var operationName = mobileFabricConfigurationForReportSupplyNationCode.integrationServices[0].operations[0];
                                var headers= {};
