...
function getDeleteOpportunitySuccessCallback (gblDeleteOpportunityList)
{
 ...
 // alert("inside getDeleteOpportunitySuccessCallback"+JSON.stringify(gblDeleteOpportunityList));
  ...
  if (gblDeleteOpportunityList!=null && gblDeleteOpportunityList!=undefined)
  {//second if
    if (gblDeleteOpportunityList !== null && gblDeleteOpportunityList!=undefined)
    {//3rd if
       // alert("2");
...
//       {//4th if
    ...
    kony.ui.Alert({ message: "Service call failed with opstatus " + DeleteOpportunityList.opstatus,alertType:constants. ALERT_TYPE_ERROR, alertTitle:"Fox News",yesLabel:"OK"}, {});
  }
}//end first if
}//end of fun
