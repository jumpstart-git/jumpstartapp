...
function authenticateMFUsingUserStore(){
                ...
                var authParams = {"userid": mobileFabricConfigurationForVolunteerCheckBox.identityServices[0].username, "password": mobileFabricConfigurationForVolunteerCheckBox.identityServices[0].password};
...
function getCheckBoxFunctionErrorCallback (error)
{
  ...
  kony.ui.Alert({
    //D022: Changed alertType from ALERT_TYPE_INFO to ALERT_TYPE_CONFIRMATION
      ...
      "yesLabel": "OK",
   "noLabel":"No",
    //D022: Changed message value from "Email notifications enabled" to 
