...
function setIndigenousBusinessProfileData(gblIndigenousBusinessProfileResponse)
{
 ...
 //business reach values has to be configured from mobile fabric 
  ...
  var professionalAffiliations = gblIndigenousBusinessProfileResponse.BusinessDTO[0].affiliations;
   var email=gblIndigenousBusinessProfileResponse.BusinessDTO[0].businessUserId.userName;  
   var singleVolImgPath1=gblIndigenousBusinessProfileResponse.BusinessDTO[0].businessUserId.imagePath;
...
searchResultProfile.businessProfileContainer.businessContactContainer.contactNumberContainer.phoneNumberContainer.businessPhoneNumber.text=businessContactNumber;
   ...
   // myProfile.show();
    ...
    searchResultProfile.businessProfileContainer.businessProfileContactActions.businessProfileEmail.isVisible=true;
