...
function authenticateMFUsingUserStore(){
                ...
                var authParams = {"userid": mobileFabricConfigurationForIndigenousRequestVolunteer.identityServices[0].username, "password": mobileFabricConfigurationForIndigenousRequestVolunteer.identityServices[0].password};
...
function postVolunteerRequestErrorCallback (error)
{
            ...
            searchResultProfile.volunteerRequestContainer.requestAVolunteerModal.isVisible=false;
  searchResultProfile.volunteerRequestContainer.requestAVolunteerModal.requestAVolunteerBody.requestAVolunteerMessageInput.text=" "; 
  searchResultProfile.volunteerRequestContainer.requestAVolunteerModal.isVisible=false;
  searchPage.show();
