...
kony.application.dismissLoadingScreen();
    ...
    kony.ui.Alert({ message: "Service call failed with opstatus " + RecommendationList.opstatus,alertType:constants. ALERT_TYPE_ERROR, alertTitle:"Fox News",yesLabel:"OK"}, {});
  }
}
