...
function openDialog(){
    var returnStatus1 = kony.phone.openMediaGallery(onselectioncallback, {mimetype:"image/*"});
}
...
function openDialogForBusiness(){
    var returnStatus2 = kony.phone.openMediaGallery(onselectioncallback1, {mimetype:"image/*"});
}
