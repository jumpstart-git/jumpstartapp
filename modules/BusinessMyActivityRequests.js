...
function initializeMobileFabricForGetBusinessRequests() {
  if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
    ...
    mobileFabricConfigurationForGetBusinessRequests.konysdkObject.init(
      mobileFabricConfigurationForGetBusinessRequests.appKey,
      mobileFabricConfigurationForGetBusinessRequests.appSecret,
      mobileFabricConfigurationForGetBusinessRequests.serviceURL,
      initializeMobileFabricForGetBusinessRequestsSuccess,
      initializeMobileFabricForGetBusinessRequestsFailure
    );
  } else {
