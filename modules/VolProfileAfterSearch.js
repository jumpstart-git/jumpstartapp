...
// //           {
        ...
        var singleVolImgPath=gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0]["users"][0].imagePath;
...
//           alert("Its not correct");}
  ...
  var daySelected=gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule[0].VolunteerScheduleDTO.days;
  var fromTime=gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule[0].VolunteerScheduleDTO.fromTime;
  var toTime=gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule[0].VolunteerScheduleDTO.toTime;
  
  var scheduleVal=daySelected+" "+fromTime+" TO "+toTime;
          for(var s=0;s<gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule.length;s++)
            {
                if(s===0){
                ...
                scheduleVal=scheduleVal+"\n"+gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule[s].VolunteerScheduleDTO.days+" "+gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule[s].VolunteerScheduleDTO.fromTime+" TO "+gblVolunteerProfileResponse["volunteersList"][0]["VolunteersDTO"][0].schedule[s].VolunteerScheduleDTO.toTime+"\n";
...
//         searchResultProfile.volunteerProfileContainer.volunteerProfileDetailsHeader.volunteerProfilePic.volunteerProfilePicImage.src="";
        ...
        searchResultProfile.volunteerProfileContainer.volunteerProfileAboutContainer.volunteerProfileAboutHeader.volunteerProfileAboutTextParent.volunteerProfileAboutText.text="About"+" "+volunteerFullNme;
        if(aboutVolunteer===null||aboutVolunteer==="null")
          aboutVolunteer="";
        ...
        //searchResultProfile.volunteerProfileContainer.volunteerProfileContactContainer.volunteerProfileBodyHeader.volunteerContactTxtArea.text=volEmail;
        searchResultProfile.volunteerProfileContainer.volunteerProfileContactContainer1.volContactNumflex.volContactNumberflex.volunteerPhoneNum.text=volPhneNo;
         searchResultProfile.volunteerProfileContainer.volunteerProfileContactContainer1.volEmailFlex.volEmailTxtFlex.volEmailTxt.text=volEmail;
        searchResultProfile.volunteerProfileContainer.volunteerProfileAvailabilityContainer.volunteerProfileAvailabilityExperienceBody.volunteerProfileAvailabilityScheduleParent.volunteerProfileAvailabilityScheduleDays.text=scheduleVal;
        searchResultProfile.volunteerProfileContainer.volunteerProfileAvailabilityContainer.volunteerProfileAvailabilityExperienceBody.volunteerProfileAvailabilityScheduleParent.volunteerProfileAvailabilityScheduleTime.text=" ";
...
kony.application.dismissLoadingScreen();
       searchResultProfile.show();
        ...
        searchResultProfile.volunteerProfileContainer.volunteerProfileContactActions.volunteerProfileEmail.isVisible=true;
