...
function businessUpdateImage() {
    ...
    if (!mobileFabricConfigurationForBusinessLogoUpload.isKonySDKObjectInitialized) { //alert("1");
        mobileFabricConfigurationForBusinessLogoUploadInit();
    } else if (mobileFabricConfigurationForBusinessLogoUpload.isKonySDKObjectInitialized) { //alert("uploadBusinessLogo");
        uploadBusinessLogo();
    }
}
//            else{
...
function authenticateMFUsingUserStore() {
    ...
    var authParams = {
        "userid": mobileFabricConfigurationForBusinessLogoUpload.identityServices[0].username,
        "password": mobileFabricConfigurationForBusinessLogoUpload.identityServices[0].password
    };
