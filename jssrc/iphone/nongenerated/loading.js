...
function getBusinessLoadExistingTaskTask99SuccessCallback(gblBusinessLoadExistingTaskList9) {
    ...
    if (gblBusinessLoadExistingTaskList9 !== null && gblBusinessLoadExistingTaskList9.opstatus === 0) { //first if
        if (gblBusinessLoadExistingTaskList9.taskList != null && gblBusinessLoadExistingTaskList9.taskList != undefined) { //second if
            if (gblBusinessLoadExistingTaskList9.taskList[0].TasksDTO !== null && gblBusinessLoadExistingTaskList9.taskList[0].TasksDTO != undefined) { //3rd if
                // alert("2");
                // Making sure we have at least 1 article returned
                if (gblBusinessLoadExistingTaskList9.taskList.length > 0) { //4th if
