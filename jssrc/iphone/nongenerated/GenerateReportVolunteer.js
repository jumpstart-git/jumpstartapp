...
function generateReportVolunteerService() {
    ...
    if (!mobileFabricConfigurationForGererateReportVolunteert.isKonySDKObjectInitialized) { //alert("1");
        initializeMobileFabricForGererateReportVolunteert();
    } else if (mobileFabricConfigurationForGererateReportVolunteert.isKonySDKObjectInitialized) { //alert("setGererateReportVolunteert");
...
function authenticateMFUsingUserStore() {
    ...
    var authParams = {
        "userid": mobileFabricConfigurationForGererateReportVolunteert.identityServices[0].username,
        "password": mobileFabricConfigurationForGererateReportVolunteert.identityServices[0].password
    };
