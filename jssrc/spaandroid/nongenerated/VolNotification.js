...
mobileFabricConfigurationForVolunteerNotification = {
    ...
    integrationServices: [{
        ...
        operations: ["getNotificationForVolunteer"]
    }],
    /*identityServices: 
                                [
                                                {
...
function getNotificationforVolunteerSuccessCallback(gblVolNotificationList) {
    ...
    if (gblVolNotificationList !== null && gblVolNotificationList.opstatus === 0) {
        ...
        if (gblVolNotificationList.notificationList[0].NotificationDTO !== null) {
            // alert("2");
    ...
    if (gblVolNoteResponse != "undefined" && gblVolNoteResponse != undefined) {
        ...
        if (gblVolNoteResponse["notificationList"].length > 0) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                var volSenderName = gblVolNoteResponse["notificationList"][i]["NotificationDTO"].senderName;
                var volNotificationTitle = gblVolNoteResponse["notificationList"][i]["NotificationDTO"].notificationTitle;
                ...
                tempVolNotData.push(VolNottestData);
            }
