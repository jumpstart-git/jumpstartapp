...
function submitPersonalInfo() {
    ...
    if (isPersonalInfoComplete) {
        ...
        validationAlert("Missing Details", "Please fill up all Mandatory Fields*");
        return false;
    }
...
function authenticateMFUsingUserStore() {
    ...
    var authParams = {
        "userid": mobileFabricConfigurationForReg.identityServices[0].username,
        "password": mobileFabricConfigurationForReg.identityServices[0].password
    };
