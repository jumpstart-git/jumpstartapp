...
function authenticateMFUsingUserStore() {
    ...
    var authParams = {
        "userid": mobileFabricConfigurationForVolCancelRequest.identityServices[0].username,
        "password": mobileFabricConfigurationForVolCancelRequest.identityServices[0].password
    };
