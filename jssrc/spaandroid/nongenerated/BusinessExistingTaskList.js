...
function getBusinessExistingTaskTaskSuccessCallback(gblBusinessExistingTaskTaskList) {
    ...
    if (gblBusinessExistingTaskTaskList !== null && gblBusinessExistingTaskTaskList.opstatus === 0) { //first if
        if (gblBusinessExistingTaskTaskList.taskList != null && gblBusinessExistingTaskTaskList.taskList != undefined) { //second if
            if (gblBusinessExistingTaskTaskList.taskList[0].TasksDTO !== null && gblBusinessExistingTaskTaskList.taskList[0].TasksDTO != undefined) { //3rd if
                // alert("2");
                // Making sure we have at least 1 article returned
                if (gblBusinessExistingTaskTaskList.taskList.length > 0) { //4th if
            ...
            kony.ui.Alert({
                message: "Service call failed with opstatus " + BusinessExistingTaskTaskList.opstatus,
