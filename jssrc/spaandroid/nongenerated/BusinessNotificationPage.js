...
function getBusinessNotificationSuccessCallback(gblBusinessNotificationList) {
    ...
    if (gblBusinessNotificationList !== null && gblBusinessNotificationList.opstatus === 0) {
        ...
        if (gblBusinessNotificationList.notificationList[0].NotificationDTO !== null) {
            // alert("2");
            ...
            if (gblBusinessNotificationList.notificationList.length > 0) {
                ...
                // var gblBusNoteResponse=JSON.stringify(BusinessNotificationList);
                ...
                //          frmFoxNews.segNewsTitle.setData(BusinessNotificationList.MessageDTO.news_item.title);
                //          kony.application.dismissLoadingScreen();
            }
        }
    } else {
        ...
        kony.ui.Alert({
            message: "Service call failed with opstatus " + BusinessNotificationList.opstatus,
    ...
    if (gblBusNoteResponse != "undefined" && gblBusNoteResponse != undefined) {
        ...
        if (gblBusNoteResponse["notificationList"].length > 0) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                var testNoteData = {
                    notificationContactImage: "imgseglogo.png",
