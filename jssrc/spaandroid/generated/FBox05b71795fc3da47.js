function initializeFBox05b71795fc3da47() {
    ...
    acceptedRequestInfoParent.add(acceptedRequestStatus, acceptedRequestBusinessName, acceptedRequestLabel, lblRequestId);
    ...
    var cancelRequest = new kony.ui.RichText({
        ...
        "isVisible": true,
        "left": "0dp",
        "onClick": AS_RichText_55b2af90803e4a41b41f97f284e70dda,
        "skin": "jumpStartRtLink110",
        "text": "RichText",
        "top": "0dp",
        "width": "33%",
        "zIndex": 1
    ...
    var acceptTask = new kony.ui.RichText({
        ...
        "isVisible": true,
        "left": "0dp",
        "onClick": AS_RichText_fa45a6f0ef24436dbc6b83d021c77e25,
        "skin": "jumpStartRtLink110",
        "text": "RichText",
        "top": "0dp",
        "width": "34%",
