...
function initializeMobileFabricForforgotPasswordVol() {
    ...
    if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        ...
        mobileFabricConfigurationForVolunteerResetPassword.konysdkObject.init(mobileFabricConfigurationForVolunteerResetPassword.appKey, mobileFabricConfigurationForVolunteerResetPassword.appSecret, mobileFabricConfigurationForVolunteerResetPassword.serviceURL, initializeMobileFabricForforgotPasswordVolSuccess, initializeMobileFabricForforgotPasswordVolFailure);
...
function getResetPasswordforVolunteer() {
    ...
    //var selectedKey = frmFoxNews.lstNewsType.selectedKey;
    if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        mobileFabricConfigurationForVolunteerResetPassword.integrationObj = mobileFabricConfigurationForVolunteerResetPassword.konysdkObject.getIntegrationService(mobileFabricConfigurationForVolunteerResetPassword.integrationServices[0].service);
