...
function getBusinessCloseTaskSuccessCallback(gblBusinessCloseTaskList) {
    ...
    if (gblBusinessCloseTaskList !== null && gblBusinessCloseTaskList.opstatus === 0) { //first if
        if (gblBusinessCloseTaskList.taskList != null && gblBusinessCloseTaskList.taskList != undefined) { //second if
            if (gblBusinessCloseTaskList.taskList[0].TasksDTO !== null && gblBusinessCloseTaskList.taskList[0].TasksDTO != undefined) { //3rd if
                // alert("2");
                // Making sure we have at least 1 article returned
                if (gblBusinessCloseTaskList.taskList.length > 0) { //4th if
        ...
        kony.ui.Alert({
            message: "Service call failed with opstatus " + BusinessCloseTaskList.opstatus,
