...
function getBusinessExistingOpenTaskForVolSuccessCallback(gblBusinessExistingOpenTaskList) {
    ...
    if (gblBusinessExistingOpenTaskList !== null && gblBusinessExistingOpenTaskList.opstatus === 0) { //first if
        // alert("1");
        if (gblBusinessExistingOpenTaskList.taskList != null && gblBusinessExistingOpenTaskList.taskList != undefined) { //second if
            // alert("2");
            if (gblBusinessExistingOpenTaskList.taskList[0].TasksDTO !== null && gblBusinessExistingOpenTaskList.taskList[0].TasksDTO != undefined) { //3rd if
                alert("3");
                // Making sure we have at least 1 article returned
                if (gblBusinessExistingOpenTaskList.taskList.length > 0) { //4th if
