...
function generateMyAcceptedRequests(dataArray) {
    if (dataArray.length > 0) {
        for (var i = 0; i < dataArray.length; i++) {
            ...
            var lblBasicBusName = {
                id: "",
                skin: "requestsCompanySkin",
                isVisible: true
            };
            var lblLayoutBusName = {
                containerWeight: 100,
                padding: [10, 15, 5, 5],
                margin: [5, 5, 5, 5],
                hExpand: false,
            ...
            var lblBasicReqStat = {
                ...
                skin: "requestsStatusSkin",
                isVisible: true
            };
            var lblLayoutReqStat = {
                containerWeight: 100,
                padding: [10, 0, 0, 0],
                margin: [5, 5, 5, 5],
                hExpand: false,
